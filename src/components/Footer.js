    ...
    <footer className="bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Button variant="link" onClick={handlebrowse} className="text-gray-400 cursor-pointer hover:text-white p-0 h-auto">
                  Browse Books
                </Button>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Button variant="link" onClick={handlecontactus} className="text-gray-400  cursor-pointer hover:text-white p-0 h-auto">
                  Contact Us
                </Button>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2025 BookSwap. All rights reserved. Made with ❤️ for diploma students.
          </p>
        </div>
      </div>
    </footer>
