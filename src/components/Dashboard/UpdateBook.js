...
import { BookPlus, Upload, Star, X, ImageIcon, Loader2, Check, RotateCw, AlertCircle, Edit } from 'lucide-react';
...
const UpdateBook = ({
  ...
  const validateForm = () => {
    ...
    if (!bookForm.status) newErrors.status = 'Status is required';
    if (bookForm.images && bookForm.images.length === 0) newErrors.images = 'At least one image is required';
    ...
    if (imgRef.current && previewCanvasRef.current && completedCrop) {
      ...
      try {
        ...
        if (blob) {
          ...
          const newImages = [...(bookForm.images || []), newImage];
          ...
          <Card className="overflow-hidden shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
            ...
            <CardHeader className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-4 sm:p-6 lg:p-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <CardTitle className="text-xl sm:text-2xl lg:text-3xl">Update Your Book</CardTitle>
            ...
            <CardContent className="p-4 sm:p-6 lg:p-8">
              <div className="space-y-8">
                ...
                {/* Condition + Year + Department + Status */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    <Label htmlFor="status" className="text-sm font-semibold text-gray-800 mb-2">Status <span className="text-red-500">*</span></Label>
                    <Select
                    ...
                    >
                      <SelectTrigger id="status" className={`w-full px-3 sm:px-4 py-2 sm:py-3 border-2 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 text-base sm:text-lg bg-white ${errors.status ? 'border-red-500' : 'border-gray-200'}`}>
                    ...
                    {errors.status && (
                      <p className="text-red-500 text-sm mt-1 flex items-center">
                        <AlertCircle className="h-4 w-4 mr-1" /> {errors.status}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div id="images">
                  ...
                  {(!bookForm.images || bookForm.images.length === 0) ? (
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      {bookForm.images && bookForm.images.length < 3 && (
                        <Button
                          variant="outline"
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <Button
                onClick={applyCrop}
                disabled={!completedCrop || uploadingImages}
