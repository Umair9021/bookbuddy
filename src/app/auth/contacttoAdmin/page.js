...
export default function ContactPage() {
    ...
    return (
        <div className="min-h-screen bg-black">
            <main className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] py-8 px-3 sm:px-6 bg-gray-100 space-y-6">
                <div className="w-full max-w-[550px]">
                    ...
                    <Card className="bg-white border border-gray-200 shadow-lg">
                        ...
                        <CardContent className="px-4 sm:px-8 lg:px-12 pb-8 sm:pb-4 bg-white">
                            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-6">
                                ...
                                <div className="space-y-2 sm:space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="w-full h-12 sm:h-12 px-4 text-sm sm:text-base bg-gray-50 border-2 border-gray-300 text-slate-700 rounded-lg focus:border-slate-500 focus:ring-2 focus:ring-slate-200 transition-all"
                                        required
                                ...
                                <div className='flex flex-row justify-between space-x-4'>
                                    ...
                                    className="w-55 bg-red-600 hover:bg-red-800 text-white font-semibold py-4 sm:py-5 px-6 sm:px-8 text-sm sm:text-lg rounded-lg transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:transform-none"
                                >
                                    Return to Login
                                </Button>
                                {/* Submit */}
                                <Button
                                    type="submit"
                                    disabled={isSubmitting}
                                    className="w-55 bg-blue-600 hover:bg-blue-900 disabled:opacity-50 text-white font-semibold py-4 sm:py-5 px-6 sm:px-8 text-sm sm:text-lg rounded-lg transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:transform-none"
                                >
                                    {isSubmitting ? (
                                        <>
