...
export default function SignupPage() {
  ...
  <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md rounded-xl">
    <div className="bg-white py-6 sm:py-8 px-3 sm:px-10 shadow sm:rounded-lg">
      {successMessage ? (
        ...
        <form className="space-y-5 sm:space-y-6" action={signUpWithEmail}>
          <div>
            <label
              htmlFor="name"
